...
| 分岐点 | 条件 |
| -- | -- |
| start | - SS系=`1~2`: 35%去A<br>- SS=3: 55%去A<br>- SS=`4~6`: 70%去A<br>- BB系+CV系=5: 65%去A<br>- BB系+CV系=6: 80%去A<br>- CV+CVB>=3: 50%去A<br>- BB系>=4: 一定概率去A<br>- 以上逐条依次判定, 去A判定失败时去B |
...
| 分岐点 | 条件 |
| -- | -- |
| start | - 高速+以上的舰队 去D<br>- BB系+CV系>=3 去C<br>- BB系+CV系=2 且 低速舰队 去C<br>- SS系>=1: 40%去C, 60%去D<br>- 其余去D |
| B | - 65%去A, 35%去F? |
...
| 分岐点 | 条件 |
| -- | -- |
| start | - CV系>=1 去B<br>- BB系>=3 去A<br>- CA系>=5 去A<br>- 装备[ドラム缶]的船数+装备[大发系]的船数>=5 去B (一船同时装备桶和大发计算两次)<br>- DD>=4 去B<br>- DD=3<br>&nbsp;&nbsp;- CL=1 去B<br>&nbsp;&nbsp;- 其余去A<br>- DD<=2 去A |
...
| 分岐点 | 条件 |
| -- | -- |
| start | - DD>=4 去A<br>- 装备[ドラム缶]的船数>=4 去A<br>- 装备[大发系]的船数>=4 去A<br>- 其余去B |
