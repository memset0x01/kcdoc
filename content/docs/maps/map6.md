...
| 分岐点 | 条件 |
| -- | -- |
| start | - CL+DD>=4 去B<br>- BBV+CAV+AV+LHA>=2 去C<br>- BB系+CV系>=5 去B<br>- BB系+CV系=4: 65%去B, 35%去C<br>- BB系+CV系<=3 去C |
...
| 分岐点 | 条件 |
| -- | -- |
| start | - LHA>=1 从2出发<br>- CV系>=1 从2出发<br>- CAV>=3 从2出发<br>- DD<=1 从2出发<br>- BB系>=2 且 舰队中包含`长门改二`/`陆奥改二`以外的BB系 从2出发<br>- 其余从1出发 |
...
| 分岐点 | 条件 |
| -- | -- |
| start | - CV系>=1 从1出发<br>- CLT>=1 从1出发<br>- BB系>=4 从1出发<br>- CL=0 从1出发<br>- 其余从2出发 |
